...
**** Symbiotic stars
In the main catlogs =1024= objects were catalog as SySt.
For cleaning the sample. At the moment i made a cut at the probability (P(SySt) > 0.75) of being SySt.
    : SPLUS_cleaning_tables.py
...
I implemented separately the color criterion on HYDRA, this because it does not appear on Gustavo database. For such I used the sqlite code.
